                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        ...
                                        <td><input type="text" name="mitra" class="form-control" required=""
                                                autocomplete="off" autofocus=""></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 30%;">Lokasi</td>
                                        <td><input type="text" name="lokasi" class="form-control" required=""
                                                autocomplete="off" autofocus=""></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 30%;">Tanggal Mulai</td>
                                        <td><input type="date" name="tanggal_mulai" class="form-control" required=""
                                                autocomplete="off" autofocus=""></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 30%;">Tanggal Akhir</td>
                                        <td><input type="date" name="tanggal_akhir" class="form-control" required=""
                                                autocomplete="off" autofocus=""></td>
                                    </tr>
        ...
        <div class="col-md-4">
            ...
            <div class="card border-danger">
                <div class="card-header bg-success text-white">
                    ...
                    <div class="float-left"><a href="?pages=<?php echo $_GET['pages'] ?>"
                        ...
                        <div class="col-md-12">
                            <form method="POST">
                                <table class="table table-striped table-bordered" style="font-size: 11px;">
                                    <tr>
                                        <td style="width: 30%;">Mitra DU/DI</td>
                                        <td><input type="text" name="mitra" class="form-control form-control-sm"
                                                required="" autocomplete="off" autofocus=""
                                                value="<?php echo $prakerin['mitra'] ?>"></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 30%;">Lokasi</td>
                                        <td><input type="text" name="lokasi" class="form-control form-control-sm"
                                                required="" autocomplete="off" autofocus=""
                                                value="<?php echo $prakerin['lokasi'] ?>"></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 30%;">Tanggal Mulai</td>
                                        <td><input type="date" name="tanggal_mulai" class="form-control form-control-sm"
                                                required="" autocomplete="off" autofocus=""
                                                value="<?php echo $prakerin['tanggal_mulai'] ?>"></td>
                                    </tr>

                                    <tr>
                                        <td style="width: 30%;">Tanggal Akhir</td>
                                        <td><input type="date" name="tanggal_akhir" class="form-control form-control-sm"
                                                required="" autocomplete="off" autofocus=""
                                                value="<?php echo $prakerin['tanggal_akhir'] ?>"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="id_user" class="form-control form-control-sm" required="">
                                                ...
                                                ?>
                                                <option value="<?php echo $rpendamping['id_user'] ?>"
                                                    <?php echo $seleuser ?>><?php echo $rpendamping['nama'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                    </tr>
