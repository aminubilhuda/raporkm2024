...
<page backtop="7mm" backbottom="7mm" backleft="7mm" backright="10mm">
    ...
    <table width="790px" style="border-collapse: collapse; font-size: 11px; margin-top: 20px;">
        <tr>
            <td style="width: 100%; text-align: center; font-size: 22px; height:25px;"><b>RAPOR</b></td>
        </tr>
        <tr>
...
<page backtop="7mm" backbottom="7mm" backleft="7mm" backright="10mm">
    ...
    <table width="790px" style="border-collapse: collapse; font-size: 11px; margin-top: 20px;">
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">1. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">2. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">3. </td>
            ...
            <td style="width: 50%; text-align: left; font-size: 14px;"><?php echo $siswa['tempat_lahir'] ?>,
                <!-- <?php echo tgl_indonesia(strtoupper(date('Y-m-d'))) ?> -->
                <?php echo tgl_indonesia(date('Y-m-d', strtotime($siswa['tanggal_lahir']))); ?>
            </td>
        </tr>


        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">4. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">5. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">6. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">7. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">8. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">9. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;"></td>
            <td style="width: 30%; text-align: left; font-size: 14px;">Di Kelas</td>
            <td style="width: 10%; text-align: center; font-size: 14px;">:</td>
            <td style="width: 50%; text-align: left; font-size: 14px;">
                <?php if($siswa['terima_kelas']=='' || $siswa['terima_kelas']=='0'){ echo '-';}else{ echo $siswa['terima_kelas'];} ?>
            </td>
        </tr>
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;"></td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">10. </td>
            <td style="width: 30%; text-align: left; font-size: 14px;">Nama Orang Tua</td>
            <td style="width: 10%; text-align: center; font-size: 14px;"></td>
            <td style="width: 50%; text-align: left; font-size: 14px;"></td>
        </tr>
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;"></td>
            <td style="width: 30%; text-align: left; font-size: 14px;">a. Ayah</td>
            <td style="width: 10%; text-align: center; font-size: 14px;">:</td>
            <td style="width: 50%; text-align: left; font-size: 14px;">
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;"></td>
            <td style="width: 30%; text-align: left; font-size: 14px;">b. Ibu</td>
            <td style="width: 10%; text-align: center; font-size: 14px;">:</td>
            <td style="width: 50%; text-align: left; font-size: 14px;">
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">11. </td>
            <td style="width: 30%; text-align: left; font-size: 14px;">Alamat Orang Tua</td>
            <td style="width: 10%; text-align: center; font-size: 14px;">:</td>
            <td style="width: 50%; text-align: left; font-size: 14px;">
                <?php if($siswa['alamat_orang_tua']=='' || $siswa['alamat_orang_tua']=='0'){ echo '-';}else{ echo $siswa['alamat_orang_tua'];} ?>
            </td>
        </tr>
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">12. </td>
            <td style="width: 30%; text-align: left; font-size: 14px;">No. Telepon Rumah</td>
            <td style="width: 10%; text-align: center; font-size: 14px;">:</td>
            <td style="width: 50%; text-align: left; font-size: 14px;">
                <?php if($siswa['kontak_ayah']=='' || $siswa['kontak_ayah']=='0'){ echo '-';}else{ echo $siswa['kontak_ayah'];} ?>
            </td>
        </tr>
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">13. </td>
            <td style="width: 30%; text-align: left; font-size: 14px;">Pekerjaan Orang Tua</td>
            <td style="width: 10%; text-align: center; font-size: 14px;"></td>
            <td style="width: 50%; text-align: left; font-size: 14px;"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">14. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">15. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">16. </td>
        ...
        <tr>
            <td style="width: 10%; text-align: center; font-size: 14px; height: 25px;">17. </td>
