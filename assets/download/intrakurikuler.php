    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 10px;" border="1">
        ...
        <tr>
            ...
            <td style="width: 50%; text-align: left; padding: 3px; vertical-align: middle; ">
                <?php  
                    ...
                    $datamax = mysqli_fetch_array(mysqli_query($mysqli,"SELECT * FROM nilai_sumatif_ph WHERE tahun='$sekolah[tahun]' AND semester='$sekolah[semester]' AND id_kelas='$siswakelas[id_kelas]' AND id_mapel='$rmapel[id_mapel]' AND id_siswa='$_GET[orderID]' ORDER BY nilai DESC LIMIT 1"));
        ...
        <tr>
            <td style="width: 50%; text-align: left; padding: 3px; vertical-align: middle; border-left: none;">
                ...
                $datamin = mysqli_fetch_array(mysqli_query($mysqli,"SELECT * FROM nilai_sumatif_ph WHERE tahun='$sekolah[tahun]' AND semester='$sekolah[semester]' AND id_kelas='$siswakelas[id_kelas]' AND id_mapel='$rmapel[id_mapel]' AND id_siswa='$_GET[orderID]' ORDER BY nilai ASC LIMIT 1"));
            ...
            <tr>
                ...
                if ($presensi_count == 0) {
                    ...
                    if (isset($presensi_data['jumlah']) && $presensi_data['jumlah'] != "") {
                        // Jika 'jumlah' lebih besar dari presensi_count, tampilkan 'jumlah'
                        if ($presensi_data['jumlah'] > $presensi_count) {
                            echo $presensi_data['jumlah'];
                        } else {
                            // Jika presensi_count lebih besar, tampilkan presensi_count
                            echo $presensi_count;
                        }
                    } else {
